<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #1450aa">舰船仿真管理系统登录</div>
      <el-form :model="data.form"  ref="formRef" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select size="large" style="width: 100%" v-model="data.form.role">
            ...
            <el-option value="TEACHER" label="数据分析师"></el-option>
            <el-option value="STUDENT" label="操作员"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
  ...
  const data = reactive({
    ...
    rules: {
      username: [
        ...
        { min: 4, message: '最少4位', trigger: 'blur' },
      ],
      password: [
